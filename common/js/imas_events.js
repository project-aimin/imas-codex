  ...
  r.onreadystatechange = function(){
   if(r.readyState == 4){
    if(r.status == 200){
     ...
     var aTime0 = new Date(parsingContent.asset.updatedAt);
     ...
     document.getElementById("slclient_info_detail").title = "Asset Version: "+ parsingContent.asset.version;
     var uTime = new Date();
  ...
  r.onreadystatechange = function(){
   if(r.readyState == 4){
    if(r.status == 200){
     ...
     document.getElementById("tdclient_info_detail").title = "Asset Version: "+ parsingContent.asset.version +", Index: "+ parsingContent.asset.indexName;
     var uTime = new Date();
     var uTimeDisp = uTime.getFullYear() +"년 "+ (uTime.getMonth()+1) +"월 "+ uTime.getDate() +"일 "+ uTime.getHours() +"시 "+ uTime.getMinutes() +"분 기준";
     document.getElementById("lastupdate_clientinfo").innerHTML = uTimeDisp;
    }else{
   ...
   r.onreadystatechange = function(){
    if(r.readyState == 4){
     if(r.status == 200){
      ...
      document.getElementById("tdclient_info_detail_k").title = "Asset Version: "+ parsingContent.asset.version +", Index: "+ parsingContent.asset.indexName;
      var uTime = new Date();
      var uTimeDisp = uTime.getFullYear() +"년 "+ (uTime.getMonth()+1) +"월 "+ uTime.getDate() +"일 "+ uTime.getHours() +"시 "+ uTime.getMinutes() +"분 기준";
